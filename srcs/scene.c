...
/*   Updated: 2018/01/26 16:01:13 by vmercadi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	scene2(t_b *b)
{
	...
	//Mur du fond
	add_plane(b, init_plane(0.0, 0.0, 1.0, -15.0, init_col(1.0, 1.0, 0.0)));
	//Mur de droite
	add_plane(b, init_plane(1.0, 0.0, 0.0, 15.0, init_col(0.0, 0.0, 1.0)));
	//Mur droit
	add_plane(b, init_plane(1.0, 0.0, 0.0, -15.0, init_col(1.0, .0, 1.0)));
	//Mur gauche jaune
	add_plane(b, init_plane(0.0, 1.0, 0.0, 15.0, init_col(0.1, 0.0, 0.0)));
	//sol violet
	add_plane(b, init_plane(0.0, 1.0, 0.0, 15.0, init_col(1.0, 0.0, 1.0)));
}
